...
export default function HomeInsights({
  ...
  aria-labelledby="pulse-intelligence-heading"
>
  <div className={styles.aiCardTop}>
    ...
    <span
      className={styles.aiLiveDot}
      aria-hidden="true"
    />
  </div>

  <h2
    id="pulse-intelligence-heading"
  ...
  <p className={styles.aiDescription}>
    Turn attached sources and community discussion
    into clearer, more useful context.
  </p>

  <div className={styles.aiFeatureList}>
    <div className={styles.aiFeatureItem}>
      <span className={styles.aiFeatureIcon}>
        01
      </span>

      <span>
        <strong>Attach a source</strong>
        <small>Upload an image or PDF</small>
      </span>
    </div>
    ...
    <div className={styles.aiFeatureItem}>
      ...
      <span>
        ...
        <small>Useful context is extracted</small>
      </span>
    </div>
    ...
    <div className={styles.aiFeatureItem}>
      ...
      <span>
        <strong>Discussion is assessed</strong>
        <small>See a PulseOpinion score</small>
      </span>
    </div>
  </div>

  <div className={styles.aiFooter}>
    <span className={styles.aiFooterCheck}>
      ✓
    </span>

    <span>
      Built into every discussion
    </span>
  </div>
</section>
