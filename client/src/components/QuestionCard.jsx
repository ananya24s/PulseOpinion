...
export default function QuestionCard({
  ...
  const [showAiContext, setShowAiContext] =
    useState(false);
  const [showPulseBot, setShowPulseBot] =
    useState(false);
...
<div className={styles.headerActions}>
  ...
  {isOwner && (
    ...
    >
      ...
      <section className={styles.pulseBotSection}>
        <button
          type="button"
          className={styles.pulseBotToggle}
          onClick={() =>
            setShowPulseBot(
              (current) => !current
            )
          }
          aria-expanded={showPulseBot}
        >
          <span
            className={
              styles.pulseBotToggleLeft
            }
          >
            <span
              className={
                styles.pulseBotAvatar
              }
              aria-hidden="true"
            >
              🤖
            ...
            <span>
              <strong>
                PulseBot’s perspective
              </strong>
              <small>
                AI-generated starting response
              </small>
            </span>
          </span>

          <span
            className={`${styles.pulseBotChevron} ${
              showPulseBot
                ? styles.pulseBotChevronOpen
                : ""
            }`}
            aria-hidden="true"
          >
        ...
        {showPulseBot && (
          <div
            className={
              styles.pulseBotContent
            }
          >
            <div
              className={
                styles.pulseBotContentHeader
              }
            >
              <span>PulseBot</span>
              <span>
            ...
            <p>
              {question.aiAnswer ||
                "PulseBot is preparing a perspective for this discussion."}
            </p>

            <small
              className={
                styles.pulseBotDisclaimer
              }
            >
              AI-generated perspective. It may
              be incomplete and should not replace
